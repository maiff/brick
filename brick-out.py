...
class Ball(object):
    ...
    def draw(self):
        ...
        screen.blit(shit, (self._xLoc,self._yLoc))
        pygame.display.flip()
    ...
    while not done:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_0 and not gameStatus:
                    main()
        ...
        if gameStatus:
            ...
            if isGameOver: # player lose
                screen.blit(textsurfaceGameOver,(size[0]//2 - 30,size[1]//2 - 30))
                textsurfaceScore = mgScore.render("score: "+str(score),False,(0,0,0))
                screen.blit(textsurfaceScore,(300,0))
            elif brickWall.hasWin(): # player win
                screen.blit(textsurfaceWin,(size[0]//2- 30,size[1]//2- 30))
                textsurfaceScore = mgScore.render("score: "+str(score),False,(0,0,0))
                screen.blit(textsurfaceScore,(300,0))
